...
export const IMAGE_SCENE = {
    ...
    IMAGES_DATA: {
        continent: { width: 1846, height: 1080, targetRepeat: { x: 0.1, y: 0.1 }, targetCoords: { x: 525, y: 354 } },
        city: { width: 1846, height: 1080, targetRepeat: { x: 0.1, y: 0.1 }, targetCoords: { x: 894, y: 558 } },
